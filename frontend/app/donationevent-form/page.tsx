          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                {activeStep === 2 && (
                  <div className="space-y-5 animate-in fade-in duration-300">
                    <div className="mb-6">
                      ...
                      <p className="text-sm text-gray-600 mt-1">Story the details below to continue</p>
                    </div>
                ...
                {activeStep === 4 && (
                  <div className="space-y-5 animate-in fade-in duration-300">
                    <div className="mb-4">
                      <h2 className="text-lg font-semibold text-gray-800">Configure details below to continue</h2>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-3">Provide account where funds will be sent (UPI ID (account) & encrypted)</p>
                ...
                {activeStep === 5 && (
                  <div className="space-y-5 animate-in fade-in duration-300">
                    <div className="mb-4">
                      <h2 className="text-lg font-semibold text-gray-800">Step 5:</h2>
                      <p className="text-sm text-gray-600 mt-1">Review<span className="text-gray-400"> details below to continue</span></p>
                    </div>
