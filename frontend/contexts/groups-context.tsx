...
// const API_BASE_URL =
//   process.env.NEXT_PUBLIC_API_URL || "https://namastep-irod.onrender.com/api";
...
//       // Tell TypeScript what the response data looks like
...
//       // Now TypeScript knows response.data exists and has a 'data' field
